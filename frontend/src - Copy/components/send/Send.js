        ...
        <>
            <div className="coll">
                ...
                {/* <div>
                    ...
                    <label for="exampleInputEmail" className="form-label">Name*</label><br></br>
                    <input type="text" name="name" className="form-control " id="exampleInputEmail" aria-describedby="emailHelp" required></input>
                    <div className="text-danger" ></div>
                </div>
                <div>

                    <label for="exampleInputEmail" className="form-label">Email*</label><br></br>
            ...
            <div className="col">
                <div>
                    ...
                    <label for="exampleInputEmail" className="form-label">Phone</label><br></br>
                    <input type="text" name="phone" className="form-control " id="exampleInputEmail" aria-describedby="emailHelp" ></input>
                    <div className="text-danger" ></div>
                </div>
                <div>

                    <label className="form-label">Company</label><br></br>
            ...
            <br></br>
            <div className='col'>
                <label for="messagebox" className="form-label-msg " required>Message*</label><br></br>
